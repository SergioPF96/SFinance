...
|-----------|-------|-------|
| I. Monorepo & Shared Code | Does any new code belong in `packages/` rather than `apps/`? Does this change any existing package public API (breaking change)? | |
...
> Any violations MUST be documented in the Complexity Tracking table before work proceeds.
