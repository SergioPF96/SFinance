...
- **Shared code**: `my_apps/packages/shared_models/`, `my_apps/packages/shared_ui/`,
...
- Adjust paths based on plan.md structure; always check Principle I before placing code in `apps/`
